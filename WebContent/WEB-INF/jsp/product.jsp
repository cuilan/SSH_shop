...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/productSubmit.js"></script>
</head>
<body>
				...
				<s:iterator var="c" value="#session.cList">
					<dl>
						...
						<s:iterator var="cs" value="#c.categorySeconds">
							<dd>
								<a
									href="${pageContext.request.contextPath}/product_findByCsid.action?csid=<s:property value="#c.csid"/>&page=1"><s:property
										value="#cs.csname" /></a>
							</dd>
						</s:iterator>
					</dl>
		...
		<div class="span18 last">
			...
			<div class="info">
				<dl>
					<dt>商城价:</dt>
					<dd>
						<strong>￥：<s:property value="model.shopPrice" />元
						</strong> 参 考 价：
						<del>
							￥
