...
<div class="span10 last">
		...
		<ul>
			<s:if test="#session.existUser == null">
				...
				<li id="headerRegister" class="headerRegister"
					...
					href="${pageContext.request.contextPath}/user_registerPage.action">注册</a>|</li>
			</s:if>
			<s:else>
				<li id="headerLogin" class="headerLogin" style="display: list-item;"><s:property
	...
	<div class="phone">
		客服热线: <strong>177 4659 8041</strong>
	</div>
</div>
