					...
					<form id="registerForm"
						...
						<table>
							<tbody>
								...
								<tr>
									<th>姓名:</th>
									<td><input type="text" id="true_name" name="name"
										class="text" maxlength="200" /> <span><s:fielderror
								...
								<tr>
									...
									<td><input type="text" id="phone" name="phone"
										class="text" /> <span><s:fielderror fieldName="phone" /></span></td>
								</tr>

								<tr>
									<th>地址:</th>
									<td><input type="text" id="addr" name="addr" class="text"
										maxlength="200" /><span><s:fielderror fieldName="addr" /></span></td>
								</tr>
								<tr>
