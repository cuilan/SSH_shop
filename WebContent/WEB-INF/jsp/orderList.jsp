					...
					<s:iterator var="order" value="pageBean.list">
						...
						<s:iterator var="orderItem" value="#order.orderItems">
							<tr>
								...
								<td><s:property value="#orderItem.product.shopPrice" /></td>
							...
							<div class="pagination">
								...
								<s:iterator var="i" begin="1" end="pageBean.totalPage">
									<s:if test="pageBean.page != #i">
										<a
											href="${pageContext.request.contextPath}/order_findByUid.action?page=<s:property value="#i"/>">
											<s:property value="#i" />
										</a>
									</s:if>
									<s:else>
								...
								<s:if test="pageBean.page != pageBean.totalPage">
									<a
										...
										class="nextPage">&nbsp;</a>
									<a
										href="${pageContext.request.contextPath}/order_findByUid.action?page=<s:property value="pageBean.totalPage"/>"
										class="lastPage">&nbsp;</a>
								</s:if>
							</div>
						</td>
