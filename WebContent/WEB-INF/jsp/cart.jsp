...
<body>
	...
	<div class="container cart">
			...
			<div class="span24">
					...
					<tbody>
						...
						<s:iterator var="cartItem" value="#session.cart.cartItems">
							<tr>
								...
								<td>￥<s:property value="#cartItem.product.shopPrice" /></td>
				...
				<div class="bottom">
					<a href="${pageContext.request.contextPath}/cart_clearCart.action"
						...
						href="${pageContext.request.contextPath}/order_save.action" id="submit"
						class="submit">提交订单</a>
				</div>
			</div>
		</s:if>
		<s:else>
			<div class="span24">
				<div class="step step1" style="margin: 78px 50px 30px 78px;">
					<h2>亲，没有您的商品！请先去购物！！！</h2>
				</div>
			</div>
		</s:else>
	</div>
